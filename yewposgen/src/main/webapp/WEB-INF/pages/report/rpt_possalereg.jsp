				...
				<div class="panel-body">
					...
					<table>
						<tr align="center" style="font-weight: bold;">
								...
								<td><spring:message code="report.msg.customertype" text="Customer Type" /></td>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
								...
								<select class="form-control" ame="schedule" id="scheduleid" onchange="getSelcetedSche()">
...
// });
var pdf_url_sale_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_POS_SALEREGIS)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_sale_reg+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&schId="+scheduleid+"&customerId="+custid+"&doctorId="+dctrid+"&itemId="+itemid+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
