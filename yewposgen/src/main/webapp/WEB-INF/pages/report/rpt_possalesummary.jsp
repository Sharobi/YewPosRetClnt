...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptsalesummary.jsp.title" text="Sales Summary..." /></p>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
								<td style="padding: 0 1px;">
									<div class="input-group">
										...
										<input type="text" readonly="readonly" class="form-control" id="strtdate" name="startDate" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
...
// });
var pdf_url_sale_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_POS_SALESUMMARY)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			//var pdfline="<iframe src='"+pdf_url_sale_reg+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&customerId="+custid+"&doctorId="+dctrid+"&itemId="+itemid+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			var pdfline="<iframe src='"+pdf_url_sale_reg+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&customerId="+custid+"&doctorId="+dctrid+"&itemId="+itemid+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			console.log(pdfline);
