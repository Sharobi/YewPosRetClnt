	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<table>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
								...
								<td width="25%" style="padding: 0 1px;"><input class="form-control-trx" id="salecustname" type="text" placeholder="type customer name..."></td>
								<td style="padding: 0 1px;width: 18%;"><select class="form-control-trx" name="schedule" id="scheduleid" onchange="getSelcetedSche()">
				...
				<div id="rptposcustledgdiv" style="height: 450px;width: 100%;"></div>
			</div>
		</div>
	</div>
</section>
...
// });
var pdf_url_customer_ledger='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_CUSTOMER_LEDGERREPORT)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_customer_ledger+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&custId="+custid+"&startDate="+strtdate+"&endDate="+enddate+"&status="+scheduleid+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			document.getElementById('rptposcustledgdiv').innerHTML=pdfline;
		}
	}
