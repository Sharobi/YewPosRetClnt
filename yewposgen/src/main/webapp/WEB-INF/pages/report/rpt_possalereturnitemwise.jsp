...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptsalereturnitem.jsp.title" text="Item Wise Sale Return..." /></p>
				...
				<div class="panel-body">
					...
					<table>
						<tr align="center" style="font-weight: bold;">
								...
								<td width="40%"><spring:message code="item.jsp.name" text="Item Name" /></td>
...
// });
var pdf_url_sale_item='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_POS_SALESRETURNITEM)%>';
	...
	function getCurrSalesItems(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_sale_item+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&customerId="+custid+"&itemId="+itemid+"&contentId="+contentid+"&manufacturerId="+manufid+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
