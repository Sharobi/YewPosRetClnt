	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div id="rpttaxslabsummarydiv" style="height: 450px;width: 100%;"></div>
			</div>
		</div>
	</div>
</section>
...
// });
var pdf_url_tax_slab_sum='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_TAX_TAXSLABSUMMARY)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_tax_slab_sum+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			document.getElementById('rpttaxslabsummarydiv').innerHTML=pdfline;
		}
	}
