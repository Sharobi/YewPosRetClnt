...
var pdf_url_purchase_order='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_PURCHASE_ORDER_ADJ)%>';
	...
	function getVendorLedger(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_purchase_order+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&distributorId="+seldistributor+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
