	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div id="rptfreeqtydistwisediv" style="height: 450px;width: 100%;"></div>
			</div>
		</div>
	</div>
</section>
...
var pdf_url_freeqty_distwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_PURCHASE_FREEQTY)%>';
	...
	function getCurrExpDistWise(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_freeqty_distwise+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&distId="+seldistributor+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			document.getElementById('rptfreeqtydistwisediv').innerHTML=pdfline;
		}
	}
