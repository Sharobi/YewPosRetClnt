...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptpurchaseitem.jsp.title" text="Item Wise Purchase Report..." /></p>
				...
				<div class="panel-body">
					...
					<table>
						<tr align="center" style="font-weight: bold;">
								...
								<td width="25%"><spring:message code="item.jsp.name" text="Item Name" /></td>
								<td width="10%"><spring:message code="report.msg.type" text="Report Type" /></td>
...
// });
var pdf_url_purchase_itemwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_PURCHASEITEM)%>';
	...
	function getCurrPurchaseItems(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_purchase_itemwise+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&distributorId="+distid+"&itemId="+itemid+"&contentId="+contentid+"&manufacturerId="+manufid+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
