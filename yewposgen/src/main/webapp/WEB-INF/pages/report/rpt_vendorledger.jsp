				...
				<div class="panel-body">
					...
					<table>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
								...
								<td style="padding: 0 1px;width: 10%;"><select class="form-control-trx" name="schedule" id="scheduleid" onchange="getSelcetedSche()">
...
// });
var pdf_url_vendor_ledger='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_VENDOR_LEDGERREPORT)%>';
	...
	function getVendorLedger(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_vendor_ledger+"?cmpnyId="+compid+"&storeId="+storeId+"&finYrId="+finyrid+"&distId="+seldistributor+"&startDate="+strtdate+"&endDate="+enddate+"&status="+scheduleid+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
