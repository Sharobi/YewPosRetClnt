...
#towndcol .col-xs-8, .col-sm-8, .col-md-8
	...
	<div id="rowmarg" class="row">
		...
		<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
			<ul class="nav nav-tabs" id="myTabs" role="tablist">
				<li role="presentation" class="active hide"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true" style="font-weight: bolder;">Cash Memo</a></li>
				<c:if test="${saleHeaderDTO.holdFlag ==0}">
				<li role="presentation" class="hide"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false" style="font-weight: bolder;">Return Memo</a></li>
				</c:if>
							...
							<div  class="panel-body-trx">
								<table>
									<c:if test="${saleId==0}">
										...
										<tr>
											<td width="16%" style="padding: 0 1px;">
...
<!-- 												</div> -->
											...
											<td   width="10%" style="padding: 0 5px;"><select class="form-control-trx" name="mulSeriesPrefix" id="mulslid" onchange="getesitype()">
											...
											<td width="25%" style="padding: 0 1px;"><input class="form-control-trx" id="salecustph" placeholder="Search by phone no "  type="text"><input type="hidden" id="salecustid" value="0"><input type="hidden" id="custCreditLimit" /></td>
											<%-- <c:if test="${sesloggedinStore.isCustomerDisplay==1}"> --%>
											<td width="35%" style="padding: 0 1px;"><input class="form-control-trx" placeholder="Search by name "  id="salecustname" type="text"></td>
											<%-- </c:if>
											<c:if test="${sesloggedinStore.isCustomerDisplay==0}">
											<td width="25%" style="padding: 0 1px;" class="hide"><input class="form-control-trx" id="salecustname" type="text"></td>
											</c:if> --%>
											...
											<td width="25%" style="padding: 0 1px;" class="hide"><input class="form-control-trx" id="saledocname" type="text"><input type="hidden" id="saledocid" value="0"></td>
							...
							<div class="panel-body-trx" id="header_div">
								...
								<table >
									<tr align="center">
										...
										<td class="hide"><spring:message code="pos.jsp.generic" text="Generic" /></td>
									...
									<tr>
										...
										<td width="18%"><input class="form-control-trx" type="text" id="item_barcode"  placeholder="Scan Barcode"></td> -->
										  <c:choose>
											 <c:when test="${sessionScope.sesloggedinUser.primarySearchType == 1}">
											     <td width="25%" style="padding: 0 5px;"><input class="form-control-trx" type="text" id="item_name" placeholder="Please type atleast 2 characters"> <input type="hidden" id="item_id" value="0"></td>
										         <td width="18%"><input class="form-control-trx" type="text" id="item_barcode"  placeholder="Scan Barcode"></td>							
										...
										<td width="20%" style="padding: 0 5px;" class="hide"><input type="hidden" id="content_id" value=""></input> <input type="hidden" id="content_Dets" value=""></input><input type="text" id="itemContent" value="" class="form-control-trx" placeholder="Please type atleast 2 characters"></td>
										<td style="padding: 0 5px;" width="8%"><input class="form-control-trx" type="text" id="item_pqty" onkeydown="numcheck(event)"  value="0"> <input type="hidden" id="item_packunitid" value="0"><input type="hidden" id="item_is_slno" value="0"><input type="hidden" id="item_taxtype" value="0"></td>
										<c:choose>
										  <c:when test="${sesloggedinStore.defaultPort=='--'}">
										...
										<td style="padding: 0 5px;" id="item_dis_td"><input class="form-control-trx" type="text" id="item_dis" value="0.0000" onkeydown="numcheck(event)" ><input type="hidden" id="item_discamt" value="0"><input type="hidden" id="item_mrpRequired_req" value="0"><input type="hidden" id="item_priceListRequired_req" value="0"><input type="hidden" id="item_expDate" tabindex="-1" readonly></td>
									...
									<tr>
										<td class="${userinfo.isManufacturerSearch==1? '' :'hide'}" style="padding: 0 1px;" >
	...
	<!--  free item aginst  item  -->
										<td colspan="2" style="padding-left: 10px;"><input type="checkbox" id="isfreeiai" onclick="javascript:itemAgainstItem()"> <spring:message code="pos.jsp.isfreeiai" text="Checked it free" /> </td>
										...
										<input type="hidden" id="item_purCostperUnit" value="0"></td>
							...
							<td style="padding: 0 1px;" id="wmonthval_td" class="hide"><input class="form-control-trx" type="text" value="0" id="warrantymonth"></td>
										...
										<c:if test="${saleHeaderDTO.isPosted !=1}">
											<c:if test="${saleHeaderDTO.holdFlag ==0}">
												<td colspan="3" align="middle"><button class="btn btn-success btn-sm" type="button" title='Add into table ' onclick="addOrUpdateItemToDetailsTable(0)" id="add_btn">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div style="overflow: auto; height:275px;" id="detail_table8">
							<table id="selitem" style="margin-bottom: 5px;" class="table table-bordered table-striped table-condensed-trx table-hover">
								<thead>
									<tr>
										...
										<th class="${userinfo.isBatch==1?' ': 'hide'}"><spring:message code="purinvdet.jsp.batch" text="Batch" /></th>
										<th class="${userinfo.isExpiry==1?' ': 'hide'}" ><spring:message code="purinvdet.jsp.expdt" text="Exp" /></th>
										...
										<th class="numeric hide"><spring:message code="purinvdet.jsp.taxprcnt" text="TAX%" /></th>
								...
								<tbody id="saletabitemdetails">
									...
									<c:if test="${!empty saleDetailsDTOs }">
										...
										<c:forEach items="${saleDetailsDTOs}" var="saleDetail">
											...
											<td class="${userinfo.isBatch==1?' ': 'hide'}" id="saletabbat">${saleDetail.batchNo}</td>
											<td class="${userinfo.isExpiry==1?' ': 'hide'}" id="saletabexpdt">${saleDetail.expiryDateFormat}</td>
									  ...
									  <td class="numeric" id="saletabamt"><fmt:formatNumber type="number" maxFractionDigits="4" minFractionDigits="4" groupingUsed="false" value="${((saleDetail.packQty*saleDetail.conversion)+saleDetail.looseQty)*saleDetail.ratePerUnit}" /></td>
											...
											<td id="saletabtaxPercentage" class="numeric hide"><fmt:formatNumber type="number" maxFractionDigits="4" minFractionDigits="4" groupingUsed="false" value="${saleDetail.taxPercentage}" /></td>
											...
											<td id="saletabcode" class="hide">${saleDetail.itemCode}</td>
											</tr>
										</c:forEach>
									</c:if>
									<%-- 						</c:if> --%>
				...
				<input type="hidden" id="lot_adjas_codef" value="<spring:message code="accgroup.jsp.lotadjs_group_code" text="LOT" />">
				<input type="hidden" id="other_adjas_codef" value="<spring:message code="accgroup.jsp.otheradjs_group_code" text="BAD" />">
				  ...
				  <input type="hidden"  id="duties_ledger_idf" value="0">
				     ...
				     <input type="hidden"  id="debitor_cahs_ledger_idf" value="0">
					  ...
					  <input type="hidden" id="otherAdjasment_ledger_idf" value="0">
					...
					<td style="padding-right: 5px;"><input class="form-control-trx" id="remarks" type="text" value="${saleHeaderDTO.remarks}"></td> --%>
								...
								<td style="padding-right: 5px;" class="hide" ><input class="form-control-trx" style="color: #000000;" type="text" id="totgrossamt" value="${saleHeaderDTO.grossAmount}" tabindex="-1" readonly></td>
								<c:if test="${mrpEnableFlag==1}">
								<td class="hide">Tot.MRP:</td>
								<td style="padding-right: 5px;" class="hide"><input class="form-control-trx" style="color: #000000;" type="text" id="totmrpamt" value="${saleHeaderDTO.totalMrp}" tabindex="-1" readonly></td>
								</c:if>
								<c:if test="${mrpEnableFlag==0}">
								<td class="hide">Tot.MRP:</td>
								...
								<td style="padding-right: 5px;" class="hide" ><input class="form-control-trx" type="text" id="totdiscamt" value="${saleHeaderDTO.discAmount}" tabindex="-1" readonly></td>
								...
								<td width="8%" ><span id="totitmcount"></span></td>
					        	<!--  for total tax -->
					        	<td width="9%" ><spring:message code="pos.jsp.stax" text="Tot.Tax" /></td>
								<td style="padding-right: 5px;width: 15%;" ><input class="form-control-trx" type="text" id="totgstamt" value="${saleHeaderDTO.taxAmount}" tabindex="-1" readonly></td>
						       <!-- for round off -->
						       <td width="9%"   style="padding-right: 5px;"><spring:message code="purinvdet.jsp.roff1" text="Round Off:" /></td>
								<td style="padding-right: 5px;width: 10%; " ><input class="form-control-trx" type="text" id="roundoff" value="${saleHeaderDTO.roundoff}" tabindex="-1" readonly="readonly"></td>
								  <!-- for other adjasment -->
					            <td  id="otherAdjasment_td"><spring:message code="purinvdet.jsp.othadj" text="Oth.Adj" />:</td>
					            <td  width="14%" style="padding: 2px 5px 0 0" ><input  onkeydown="numcheck(event)" class="form-control-trx" type="text" id="otheradjasment" value="${saleHeaderDTO.othAdjAmount}" tabindex="-1" >

               					  <!-- for lot  adjasment -->
								<td class="hide" id="flotid"><spring:message code="purinvdet.jsp.ltadj" text="Lt.Adj" />:</td>
					            <td style="padding: 2px 5px 0 0" ><input class="form-control-trx hide" type="text" id="totltadj" value="${saleHeaderDTO.lotAdjAmount}" tabindex="-1" readonly="readonly">
							...
							<tr>
								...
								<td style="padding-right: 5px;"><input class="form-control-trx" onkeydown="numcheck(event)"    type="text" id="spcldiscperc" value="${saleHeaderDTO.specialDiscPer}" onkeyup="calculateSpclDisc()"></td>
								<td  id="remarkstext"><spring:message code="purinvdet.jsp.remarks1" text="Remarks :" /></td>
								<td  style="padding: 3px 5px 0 0" colspan="4"><input class="form-control-trx" id="remarks" type="text" value="${saleHeaderDTO.remarks}"></td>
								<td colspan="2" class="font-bold hide"><c:if test="${saleId!=0}">
								...
								<td class="hide" style="padding-right: 5px;"><input class="form-control-trx" style="width:50%" readonly="readonly" tabindex="-1" type="text" id="spcldisc" value="${saleHeaderDTO.specialDiscAmount}" onkeyup="calculateSpclDiscPrcnt()"></td>
								 <c:if test="${saleId==0}">
								<td class="hide">Ret Amt:</td>
								<td style="padding-right: 5px;" class="hide"><input class="form-control-trx" readonly="readonly" tabindex="-1" type="text" id="retamtvalsamepage" value="0"></td>
								</c:if>

								 <c:if test="${saleId!=0&&saleHeaderDTO.holdFlag ==0}">
								<td class="hide">Ret Amt:</td>
								<td style="padding-right: 5px;" class="hide"><input class="form-control-trx" readonly="readonly" tabindex="-1" type="text" id="retamtvalsamepage" value="${saleHeaderDTO.totalReturnAmount}"></td>
								</c:if>

						<!-- for net total  -->
								<td   style="text-align:  center; "><span style="font-size: 22px; font-weight: bold;    color: #d43f3a;"><spring:message code="purinvdet.jsp.nettotal" text="NetTotal:" /></span></td>
								<td colspan="2"  style="padding-right: 5px;"><input class="form-control-trx" style="font-weight: bold; color: #000000;     font-size: 20px; background-color: #ebccd1;" type="text" id="nettot" value="${saleHeaderDTO.netAmount}" tabindex="-1" readonly></td>
					...
					<div id="rightmar" class="panel-trx panel-default">
							<div class="panel-body-trx">
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<c:if test="${saleHeaderDTO.holdFlag ==0}">
								<button class="btn btn-primary btn-sm" type="button" title="Add Sales Return Memo" onclick="openretadjmod()" id="" style="text-transform: uppercase;">
									...
									<spring:message code="pos.jsp.retrnmemo1" text="Memo" />
								</button>
							</c:if>
							<c:if test="${saleHeaderDTO.holdFlag ==1}">
								<button class="btn btn-primary btn-sm" type="button" title="View Sales Return Memo" onclick="viewretadjamt()" id="" style="text-transform: uppercase;">
									<i class="fa fa-reply"></i>
									<spring:message code="pos.jsp.retrnmemo1" text="Memo" />
								</button>
							</c:if>
						...
						<div class="form-group">
							...
							<c:if test="${numerickeyboardon==0}">
								<input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="tenderamt" value="${saleHeaderDTO.tenderAmount}" onblur="cTA()">
							</c:if>
							<c:if test="${numerickeyboardon==1}">
								<input class="form-control-trx tenderamt" type="text" onkeydown="numcheck(event)" id="tenderamt" value="${saleHeaderDTO.tenderAmount}" onblur="cTA()">
							</c:if>
							</div>
							<div class="col-sm-3">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
							<c:if test="${numerickeyboardon==0}">
								<input class="form-control-trx" type="text" id="cashAmt" onkeydown="numcheck(event)"  value="${saleHeaderDTO.cashAmount}">
							</c:if>
							<c:if test="${numerickeyboardon==1}">
								<input class="form-control-trx cashAmt" type="text" onkeydown="numcheck(event)"  id="cashAmt" value="${saleHeaderDTO.cashAmount}">
							</c:if>
							</div>
							<div class="col-sm-3">
							</div>
						...
						<div class="form-group">
							...
							<div id="creditCustDiv" class="col-sm-8 col-sm-8 hide" style="padding-left: 14px;">
								<div class="col-sm-4" style="padding: 0;">
									<input class="form-control-trx" type="text" id="creditAmt" value="${saleHeaderDTO.creditAmount}" readonly="readonly">
								</div>
								<div class="col-sm-4">
									<label class="control-label"><spring:message code="pos.jsp.avlamt" text="AvlAmt" /></label>
								</div>
								<div class="col-sm-4" style="padding: 0;">
						...
						<div id="carddiv" style="display: none;">
							<div class="form-group">
								...
								<c:if test="${numerickeyboardon==1}">
									<input class="form-control-trx cardAmt" onkeydown="numcheck(event)"  type="text" id="cardAmt" value="${saleHeaderDTO.cardAmount}">
								</c:if>
								</div>
								<div class="col-sm-3">
								</div>
						...
						<c:if test="${saleHeaderDTO.holdFlag !=1}">
							<div id="keypad" align="center">
									<table class="ui-bar-a" id="n_retkeypad">
										<tr>

											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">7</a></td>
											<td style="padding: 5px;"><a data-role="button"
												data-theme="b" class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">8</a></td>
											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">9</a></td>
											<td style="padding: 0px 5px;" class="hide"><a
												data-role="button" data-theme="b"
												class="btn btn-primary btn-lg bigcurr"
												style="padding: 10px 29px;">100</a></td>
										...
										<tr>
											...
											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">4</a></td>
											<td style="padding: 0 5px;"><a data-role="button"
												data-theme="b" class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">5</a></td>
											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">6</a></td>
											<td style="padding: 0px 5px;" class="hide"><a
												data-role="button" data-theme="b"
												class="btn btn-primary btn-lg bigcurr"
												style="padding: 10px 34px;">50</a></td>
										...
										<tr>
											...
											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">1</a></td>
											<td style="padding: 5px 5px;"><a data-role="button"
												data-theme="b" class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">2</a></td>
											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumero"
												style="background-color: #637094;">3</a></td>
											<td style="padding: 0px 5px;" class="hide"><a
												data-role="button" data-theme="b"
												class="btn btn-primary btn-lg bigcurr"
												style="padding: 10px 34px;">20</a></td>
										...
										<tr>
											...
											<td><a data-role="button" data-theme="b"
												class="btn btn-primary btn-lg retnumerozero"
												style="background-color: #637094;">0</a></td>
											<td style="padding: 0 5px;"><a data-role="button"
												data-theme="e" class="btn btn-primary btn-lg retnumero"
												style="padding: 7px 36px; background-color: #637094;">.</a></td>
											<td><a data-role="button" data-theme="e"
												class="btn btn-primary btn-lg retnumerodzero"
												style="padding: 7px 30px; background-color: #637094;">00</a></td>
											<td style="padding: 0px 5px;" class="hide"><a
												data-role="button" data-theme="b"
												class="btn btn-primary btn-lg bigcurr"
												style="padding: 10px 34px;">10</a></td>
										</tr>
										<tr>
											<td style="padding: 5px 0px 0px 0px;"><a
												data-role="button"
												style="height: 38px; width: 82px; padding-top: 9px;"
												data-theme="e" class="btn btn-success" id="done"
												onclick="javascript:payExtAmt()" title='Pay Exact Amount'><font
													style="text-align: center; font-weight: bold;">EXT
														AMT<font></font></a></td>
											<td style="padding: 5px 5px 0px 5px;"><a
												data-role="button" data-theme="e"
												class="btn btn-warning btn-lg retclr" title='Clear '>c</a></td>
											<td style="padding: 5px 5px 0px 0px;"><a
												data-role="button" data-theme="e"
												class="btn btn-danger btn-lg retdel" title='Delete'>x</a></td>
											<td></td>
										</tr>
									</table>
								</div>
						...
						<div>
							<span id="alertmessagecont" style="font-weight: bold; color: red;"> </span><br>

							<c:if test="${saleHeaderDTO.holdFlag ==0}">
						<button type="button" class="btn btn-default hide" data-dismiss="modal" onclick="clearSaleInv()">
				...
				<c:if test="${saleHeaderDTO.holdFlag ==1}">
				  ...
				  <c:if test="${saleHeaderDTO.isPosted !=1}">
										...
										</button> <c:if test="${saleHeaderDTO.holdFlag ==0}">
											<button class="btn btn-primary btn-sm hide" style="padding: 5px 30px;" type="button" id="payButtId" onclick="paySaleInvModal()">
												<spring:message code="pos.jsp.payBtn" text="PAY" />
											</button>
										</c:if> <c:if test="${saleHeaderDTO.holdFlag ==1}">
											<button class="btn btn-primary btn-sm hide" style="padding: 5px 30px;" title="Sales Payment Detials Button " type="button" onclick="paySaleInvModal1()">
				...
				<c:if test="${saleHeaderDTO.holdFlag ==0}">
					<button type="button" id="paymentidnew" onclick="paySaleInv()"  title="Sales Payment Button " style="padding: 5px 25px;" class="btn btn-theme btn-sm">
						<spring:message code="footer.jsp.btn.pay" text="PAY" />
					</button>
				</c:if>
					...
					<table>
						<c:if test="${saleRetId==0}">
							...
							<tr>
								...
								<td style="padding: 0 1px;"><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="retmemoDoc" value="SIM" size="4" ></td>
								...
								<td style="padding: 0 1px;">
									<div class="input-group">
										...
										<div class="input-group-addon" onclick="getRetSaleDetbyInvId(document.getElementById('invnorsp').value,document.getElementById('retmemoFinyr').value,document.getElementById('retmemoDoc').value)">
				...
				<div  class="panel-body-trx" id="header_div_rsp">
					<table>
						<tr align="center" style="font-weight: bold;">
							<td><spring:message code="purinvdet.jsp.itemname" text="Item Name" /></td>
							<td>Barcode</td>
							<td id="pqty_label"><spring:message code="purinvdet.jsp.pqty" text="Qty" /></td>
							<td id="lqty_label" class="hide"><spring:message code="purinvdet.jsp.lqty" text="L.Qty" /></td>
						...
						<tr>
							...
							<td style="padding: 0 1px;" class="hide"><input class="form-control-trx" type="text" id="item_conv_rsp" readonly></td>
			...
			<%-- <div class="col-sm-12" id="saleInvDiv">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<c:if test="${numerickeyboardon==1}">
								<input class="form-control-trx tenderamt" type="text" id="tenderamt" value="${saleHeaderDTO.tenderAmount}" >
							</c:if>
							</div>
							<div class="col-sm-3">
							</div>
						...
						<div class="form-group">
							...
							<c:if test="${numerickeyboardon==1}">
								<input class="form-control-trx cashAmt" type="text" id="cashAmt" value="${saleHeaderDTO.cashAmount}">
							</c:if>
							</div>
							<div class="col-sm-3">
							</div>
						...
						<div id="carddiv" style="display: none;">
							<div class="form-group">
								...
								<c:if test="${numerickeyboardon==1}">
									<input class="form-control-trx cardAmt" type="text" id="cardAmt" value="${saleHeaderDTO.cardAmount}">
								</c:if>
								</div>
								<div class="col-sm-3">
								</div>
...
<div class="modal fade" id="saletableItemDelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog"  style="width: 204px;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">
					<spring:message code="footer.jsp.alert" text="Alert!"></spring:message>
...
<script src="${pageContext.request.contextPath }/assets/js/pos/cashmemo/posnew2.js"></script>
...
<%-- 	<script src="${pageContext.request.contextPath }/assets/js/common/common_en.js"></script> --%>
	...
	<script src="${pageContext.request.contextPath}/assets/js/common/numerickey.js"></script>
</c:if>
<script type="text/javascript">
	...
	/*
	 for batch and expire configurable
	*/
	var EnableBatch=${userinfo.isBatch};
	var EnableExp=${userinfo.isExpiry};
  ...
  */
	...
	/* $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
		...
		/*
		 showing Credit Amount field for hole bill

		*/
		var temp_hold_flag=${saleHeaderDTO.holdFlag};
		var temp_sale_id=${saleId};
		if (temp_hold_flag==0 && temp_sale_id!=0) {
			paySaleInvModal();
		}
	...
	$(document).ready(function() {
		...
		getvendorledger_sale($('#dicount_codef').val(),0,0,4);// for sunndry creditor
	...
	//	$("#cashAmt").val(parseFloat(Number(nettot)).toFixed(2));
