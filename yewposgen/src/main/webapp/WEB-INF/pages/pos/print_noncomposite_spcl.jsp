...
<div id="printdiv"  style="width:100%;display:flex">
         ...
         <div style="border-right: 1px solid black;border-left: 1px solid black;border-top: 1px solid black">
          <div  style="padding:2px 0px 2px 0px;width:100%;display:flex">
          	  ...
          	  <!-- /*Sayantan Mahanty added date-21/02/2020*/ -->
          	  		<%-- <img src="${pageContext.request.contextPath}/assets/images/logo/logo_new.png" alt="" style="width:90%;margin-top:30px"> --%>
          	  </div>
          	  <div style="width:50%;text-align:center"> 
                    <h3 style="font-size:18px;margine-top:2px;"> <b> TAX INVOICE </b> </h3> 
          ...
          <div style="border-top:1px solid black;display:flex;width:100%">
          	  <div style="border-right:1px solid black;padding-bottom:20px;width:50%"> 
                    ...
                    <div style="display:flex;width:100%">
                    	...
                    	<div style="width:50%"> 
                    	     <c:set var = "invNo" value = "${saleHeaderDTO.invNo}" />
                    	     <c:set var = "orderNo" value = "${fn:substring(invNo, 9, 14)}" />
                    		<h4>${saleDetailsDTOs[0].saleOrderInvNo} </h4>
                    	</div>
                    </div>
          	  </div> 
          	  <div style="width:50%"> 
  ...
  <table style="width:100%;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black">
    ...
    <c:set var="noofline" value="10"></c:set>
						...
						<c:if test="${!empty saleDetailsDTOs }">
							...
							<tr>
						      ...
						      <td><fmt:formatNumber value="${saleDetail.ratePerUnit}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td colspan="2"><fmt:formatNumber value="${saleDetail.totalAmount}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td><fmt:formatNumber value="${saleDetail.disc}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td><fmt:formatNumber value="${saleDetail.taxableAmount}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td>${saleDetail.cgstPercentage}</td>
						      <td><fmt:formatNumber value="${saleDetail.cgst}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td>${saleDetail.sgstPercentage}</td>
						      <td><fmt:formatNumber value="${saleDetail.sgst}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td>${saleDetail.igstPercentage}</td>
						      <td><fmt:formatNumber value="${saleDetail.igst}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						    </tr>
						    <c:set var="totunitprice" value="${totunitprice+saleDetail.rate}"></c:set>
						    <c:set var="totamnt" value="${totamnt+saleDetail.totalAmount}"></c:set>
    ...
    <tr>
        ...
        <%-- <th colspan="2" style="text-align:right" id="totInvValue"> <fmt:formatNumber value="${saleHeaderDTO.netAmount-saleHeaderDTO.adjAmount}" currencySymbol="" type="currency" groupingUsed="false" /></th> --%>
        <th colspan="2" style="text-align:right" id="totInvValue1"> <fmt:formatNumber value="${totTexableValue+saleDetail.taxableAmount}" currencySymbol="" type="currency" groupingUsed="false" /></th>
    </tr>
    <tr>
        <th colspan="11"><span id="totInvValueWord" ></span></th>
        <th colspan="4" style="text-align:right"> Total GST Amount </th>
        <th colspan="2" style="text-align:right"><fmt:formatNumber value="${saleHeaderDTO.taxAmount}"/> </th>
    </tr>
    <tr>
        <th colspan="11"> </th>
    ...
    <tr>
       <th colspan="4" style="text-align:right"><b> Invoice Total </b></th>
        ...
        <%-- <th colspan="2" style="text-align:right" id="totInvValue"><b> <fmt:formatNumber value="${totTexableValue+saleDetail.taxableAmount+saleHeaderDTO.taxAmount}" currencySymbol="" type="currency" groupingUsed="false" /></b></th> --%>
    </tr>
    <tr>
