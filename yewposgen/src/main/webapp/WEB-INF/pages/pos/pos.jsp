...
<!-- 												</div> -->
									...
									<c:if test="${saleId!=0}">
										...
										<tr>
											...
											<c:choose>
											  <c:when test="${sessionScope.sesloggedinUser.companyId == 18}">
											     <td width="25%" style="padding: 0 1px;" class=""><input class="form-control-trx" type="text" id="saledocname" value="${saleHeaderDTO.doctorName}"> <input type="hidden" id="saledocid" value="${saleHeaderDTO.doctorId}"></td>
											      <td></td>
													<td id="add_doc_td" class="hide">
														<button class="btn btn-primary" type="button" onclick="openAddModal('tailor')">
															<i class="fa fa-plus"></i>
											...
											<c:if test="${saleHeaderDTO.holdFlag ==0}">
												<td colspan="3" align="middle"><button class="btn btn-success btn-sm" title='Add into table ' type="button" onclick="addOrUpdateItemToDetailsTable(0)" id="add_btn">
													...
													<button class="btn btn-primary btn-sm" type="button" title='Clear content' onclick="clearHeaderDiv()">
													 ...
													 <c:if test="${userinfo.isOnBillPurchase==1}">
								...
								<tbody id="saletabitemdetails">
									...
									<c:if test="${!empty saleDetailsDTOs }">
										...
										<!-- <tr> -->
											...
											<td id="saletabitembarcode">${saleDetail.sku}</td>
                                         ...
                                         <td class="numeric" id="saletabamt"><fmt:formatNumber type="number" maxFractionDigits="4" minFractionDigits="4" groupingUsed="false" value="${(saleDetail.packQty*saleDetail.ratePerUnit)}" /></td>
  										...
  										<td class="numeric" id="saletabamt"><fmt:formatNumber type="number" maxFractionDigits="4" minFractionDigits="4" groupingUsed="false" value="${((saleDetail.packQty*saleDetail.conversion)+saleDetail.looseQty)*saleDetail.ratePerUnit}" /></td>
											...
											<td id="saleorderid" class="numeric hide">${saleDetail.saleOrderId}</td>
											...
											<td id="saletabremarks" class="hide">${saleDetail.remarks}</td>
											</tr>
										</c:forEach>
						...
						<table  id="final_table8">
							<tr>
					           ...
					           <td style="padding-right: 5px;"><input class="form-control-trx" id="remarks" type="text" value="${saleHeaderDTO.remarks}"></td> --%>
								<td ><spring:message code="purinvdet.jsp.total" text="Total:" />:</td>
								<td style="padding-right: 5px;"><input class="form-control-trx" style="color: #000000;" type="text" id="totgrossamt" value="${saleHeaderDTO.grossAmount}" tabindex="-1" readonly>
								    <input class="form-control-trx hide"  type="text" id="hiddentotgrossamt" value="${saleHeaderDTO.grossAmount}" tabindex="-1" readonly>
								</td>
							...
							<tr>
								...
								<td style="padding-right: 5px;"><input class="form-control-trx" tabindex="-1" type="text" id="spcldisc" value="${saleHeaderDTO.specialDiscAmount}" onkeyup="calculateSpclDiscPrcnt()" onkeydown="numcheck(event)"></td>
			...
			<table id="final_table82" >
				...
				<tr>
					...
					<td colspan="3" style="padding-top: 4px; padding-right: 4px;">
							...
							<button class="btn btn-info btn-sm"  title="For new sale return "  type="button" id="" onclick="openRetMemo()">
								NEW
							</button>
	...
	<div class="modal-dialog" style="width: 766px;">
		<div class="modal-content">
			<div class="modal-header">
				<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
				<h4 class="modal-title" id="myModalLabel">
					<spring:message code="pos.jsp.saleorderdetfor" text="Sale Order Details for" />
					<spring:message code="purinvdet.jsp.invno" text="Invoice No" />. SO/${sessionScope.sesloggedinUser.finyrCode}/
					<span id="searchmodorderno"> </span>
				</h4>
			</div>
			<div class="modal-body">
				<div id="purorderdetnotfounddiv" class="hide">
					<span class="font-bold">No Sale Order found for this order number or Please select a Customer.</span>
				</div>
					...
					<table id="searchordermodtable"
						...
						<thead>
							<tr>
								...
								<th><spring:message code="sale.jsp.add" text="Add" /></th>
							</tr>
						</thead>
	...
	<div class="modal-dialog" >
		<div class="modal-content">
			...
			<div class="col-sm-12" id="saleInvDiv">
					<div class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" style="font-size: 16px; font-weight: bold; color: #d43f3a;">Advanced Amount :</label>
							<div class="col-sm-5">
								<input class="form-control-trx" type="text" style="font-weight: bold; color: #000000; background-color: #ebccd1;" id="so_adv_amt" value="0" readonly="readonly">
							</div>
							<div class="col-sm-3">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<c:if test="${numerickeyboardon==0}">
								<input class="form-control-trx" type="text" id="tenderamt" onkeydown="numcheck(event)"  value="${saleHeaderDTO.tenderAmount}">
							</c:if>
...
<div class="modal fade" id="customerAddEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
 ...
 --%>
						...
						<!-- 		<div class="input-group"> -->
									...
									<option value="${userinfo.countryId}"></option><!-- /*Sayantan Mahanty added date-2/03/2020*/ -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-horizontal">
					<div class="col-sm-6 col-sm-6 ">
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" id="doc_name_label"><spring:message code="dctr.jsp.nameonly" text="Name" /> <span class="required_star">*</span></label>
							<div class="col-sm-8">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Purchase modal</h4>
      </div>
      <div class="modal-body" style="height:800px;">
        <p></p>
        <iframe src="${pageContext.request.contextPath }/purchaseinvoice/loadpurchaseinvoice.htm" style="width:100%;height:100%;"></iframe>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<div class="modal fade" id="stkdetModal_so" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
			...
			<div class="modal-body">
				<div>
					<span class="font-bold"><spring:message code="itemmstr.jsp.manufacturer" text="Manufacturer" /> :</span> <span id="modmanufname_so"></span>
				</div>
				<div class="hide">
					<span class="font-bold"><spring:message code="itemmstr.jsp.content" text="Content" /> :</span> <span id="modcontentname_so"> </span>
				</div>
				<div>
					<span class="font-bold"><spring:message code="itemmstr.jsp.group" text="Group" /> :</span> <span id="modgroupname_so"> </span>
				</div>
				<div>
					<span class="font-bold"><spring:message code="itemmstr.jsp.rack" text="Rack" /> :</span> <span id="modrackname_so">  </span>
				</div>
				<div>
					<span class="font-bold">Note :</span> <span id="moditemnote_so"> </span>
				</div>
				<!-- <div id="snditmtopodiv" class="">
					<input type="hidden" id="senditemtopoid">
					<button type="button" onclick="sendItemToPO(1)" class="btn btn-theme">Send Item To PO</button>
				...
				<div id="itemnotfounddiv_so" class="hide">
					<input type="hidden" id="itemnotfoundid_so"> <span class="font-bold" id="itemnotfound"><spring:message code="pos.jsp.nostockerror" text="No stock found for" /> <span id="itemnotfoundname_so"> </span>

						<button type="button" onclick="getGenericMed()" data-dismiss="modal" class="btn btn-theme hide">
							<spring:message code="footer.jsp.btn.getaltmed" text="Get Alternate Medicine" />
						</button></span>
				</div>
				<div style="max-height: 300px; height: 200px; overflow: auto; margin-top: 1%;" id="modtable_so">
					<table id="so_itemstockdetails" class="table table-bordered table-striped table-condensed-trx table-hover">
						<thead>
							<tr>
								<th><spring:message code="purinvdet.jsp.batch" text="Batch" /></th>
								<th><spring:message code="purinvdet.jsp.expdt" text="Exp" /></th>
...
<script type="text/javascript">
	...
	console.log("isOptical = "+isOptical);
