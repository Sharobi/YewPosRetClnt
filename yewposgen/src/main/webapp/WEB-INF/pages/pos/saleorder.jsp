...
.ui-autocomplete {
	...
	overflow-y: scroll; max-height: 250px; width: 100px; word-break: break-all;
}
				...
				<input type="hidden" id="dayToPurchase" value="${dayToPurchase}" />
					<table>
						<tr align="center" style="font-weight: bold;">
							...
							<td class="hide"><spring:message code="purorder.jsp.ordertype" text="Order Type" /></td>
						...
						<tr>
							...
							<td class="hide" style="padding: 0 1px;" class=""><input class="form-control-trx" type="text" id="salediscount" value="${saleHeaderDTO.customerDiscPer}" readonly></td>
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="salecustph" value="${saleHeaderDTO.customerPhone}"> <input type="hidden" id="salecustid" value="${saleHeaderDTO.customerId}"><input type="hidden" id="custCreditLimit" value="${saleHeaderDTO.creditLimit}" /><input type="hidden" id="custEmail" value="${saleHeaderDTO.customerEmail}" /></td>
							<c:if test="${sesloggedinStore.isCustomerDisplay==1}">
							...
							<td class="hide" style="padding: 0 1px;">
							...
							<td style="padding: 0 1px;" class="hide"><input class="form-control-trx" onkeydown="numcheck(event)" id="saleAdvAmount" value="0"></td>
							<c:choose>
								  <c:when test="${sessionScope.sesloggedinUser.companyId == 18}">
							...
							<c:if test="${isOptical==1}">
								...
								<form action="${pageContext.request.contextPath }/saleorder/uploadprescription.htm" id="prescription_upload_form" method="post" enctype="multipart/form-data">
									...
									<table title="Please select .jpg files only">
										<tr>
											<td colspan="3">
												<input class="form-control" type="file" name="fileUpload" id="fileUpload" accept=".jpg" />
											</td>
											<td><input type="hidden" id="fileName"></td>
											<td><div id="fumessage" style="color:green;"></div></td>
											...
											<!-- <td width="7%"></td>
											<td colspan="2"><input type="button" id="stock_upload" onclick="uploadPrescription();" style="padding: 5px 8px; text-transform: uppercase;" class="btn btn-success btn-sm" value="<spring:message code="cmn.jsp.btn.submit" text="Upload" />" /></td> -->
										</tr>
									</table>
								</form>
								</td>
				...
				<div class="panel-body-trx" id="header_div">
					<table>
						...
						<tr>
							...
							<td style="padding: 0 1px;" class="hide"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="mrp"></td>
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" onkeydown="numcheck(event)" id="rate"></td>
							<td class="hide" style="padding: 0 1px;"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="sale_rate"></td>
							...
							<td id="itmremarks_td" width="15%"><input class="form-control-trx" type="text" value="" id="itmremarks"></td>
						</tr>
						<tr align="center" style="font-weight: bold;">
						...
						<tr>
							...
							<td class="hide">
								<input type="hidden" id="itemdualstock" />
				...
				<tr>
					...
					<td>
					    ...
					    <%-- <c:if test="${sesloggedinStore.isMailEnable==1}">
					     Mail Order: 
						<input type="checkbox" id="mailInv" name="mailInv"  style="zoom: 1.5; vertical-align: middle; margin: 0px;">
					    </c:if> --%>
					</td>
			...
			<div class="modal-body">
				<div class="form-horizontal">
					...
					<div class="col-sm-6 col-sm-6 ">
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" id="licenceNo_label">
							<spring:message code="vendor.jsp.licenceno" text="Licence No" /> <span class="required_star">*</span></label>
							<div class="col-sm-8">
	...
	<div class="modal-dialog" style="width: 836px;">
		<div class="modal-content">
			<div class="modal-header">
				<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
				<h4 class="modal-title" id="myModalLabel">
					<span id="headertextcustomer"></span>
				</h4>
			</div>
			<div class="modal-body">
				<div class="form-horizontal">
					<div class="col-sm-6 col-sm-6 ">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" id="cuspin" class="form-control" onkeydown="numcheck(event)">
							</div>
						</div>
					<div class="form-group">
 ...
 --%>
					...
					<!-- this for stateName  -->
						<div class="form-group">
						 ...
						 <!--  onChange="getCityByState()"-->
									<select class="form-control-trx" name="state" id="custstate"  onChange="getCityByState()">
										<option value="0">Select...</option>
				 ...
				 <div class="form-group">
							...
							<!--onChange="getZoneByCity()"  -->
								<div class="input-group">
									<select class="form-control-trx" name="city" id="custcity" >
										<option value="0">Select...</option>
									</select>
									<div class="input-group-btn">
      ...
      <div class="modal-body">
		 ...
		 <!--  <p>The .table-bordered class adds borders to a table:</p>  -->           
		  <table class="table table-bordered table-responsive power-table">
			...
			<tr>
				<th>D.V</th>
				<td><input type="number" id="r_dv_sph" /></td>
				<td><input type="number" id="r_dv_cyl" /></td>
				<td><input type="number" id="r_dv_axis" /></td>
				<td><input type="number" id="l_dv_sph" /></td>
				<td><input type="number" id="l_dv_cyl" /></td>
				<td><input type="number" id="l_dv_axis" /></td>
			</tr>
			<tr>
				<th>N.V</th>
				<td><input type="number" id="r_nv_sph" /></td>
				<td><input type="number" id="r_nv_cyl" /></td>
				<td><input type="number" id="r_nv_axis" /></td>
				<td><input type="number" id="l_nv_sph" /></td>
				<td><input type="number" id="l_nv_cyl" /></td>
				<td><input type="number" id="l_nv_axis" /></td>
			</tr>
			<tr>
				<th>Add</th>
				<td><input type="number" id="r_add" /></td>
				<td></td>
				<td></td>
				<td><input type="number" id="l_add" /></td>
				<td></td>
				<td></td>
			</tr>
		    </tbody>
...
<script src="${pageContext.request.contextPath }/assets/js/pos/saleorder/saleorder.js"></script>
