	...
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12" id="header_filter1">
			<div class="panel-trx panel-default">
				...
				<!-- new for return stock-->
				<div class="modal fade" id="quantityIsnoAv" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
							...
							<div class="modal-body">
								<h5><spring:message code="itemmstr.jsp.qantityntexits.error" text="Quantity is not  available please enter less then or equal" /> <b>  [<span id="crstk"></span>] </b></h5>
							</div>
							<div class="modal-footer">
				...
				<input type="hidden" id="isMrpEnableFlag" value="${sessionScope.sesloggedinUser.isMrpEnable}" />
					<table>
						<tr align="center" >
							...
							<td width="9%" id="purModeLabel" class="hide"><spring:message code="purinvdet.jsp.mode" text="Mode" /></td>
						</tr>
						<tr>
							...
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="purOrderDoc" value="${poDefaultPrefix}/" size="4" readonly></td>
									...
									<td style="padding: 0 1px;" width="11%">
										<div class="input-group">
							...
							<td style="padding: 0 1px;" id="bill_no"><input class="form-control-trx" type="text" id="billno" readonly="readonly"></td>
							...
							<td width="5%"><label>Direct <input style="margin-top:5px;" type="checkbox" id="purtype" checked></label></td>

							<td style="padding: 0 1px;" id="purMode">
				...
				<div class="panel-body-trx" id="header_div">
					<table id="header_pur_tbl">
						...
						<tr>
							...
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="pqty" onkeydown="numcheck(event)"  onclick="" onblur="javascript:openSerialModal(Number($(this).val())+Number(Math.floor($('#free').val())))"><input type="hidden" id="punitid" /> <input type="hidden" id="serialnumberreq" value="0" /> <input type="hidden" id="oldpqty" value="0" /></td>
							...
							<td style="padding: 0 1px;" id="mrp_td" class="hide"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="mrp"></td>
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text"  onkeydown="numcheck(event)" id="rate"><input type="hidden" id="rateNonFree" /></td>
							<td style="padding: 0 1px;" id="sale_rate_val" class="hide"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="sale_rate"></td>
						...
						<td style="padding: 0 1px;" id="locationval_td" class="hide">
							...
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="free" onblur="openFreeSlNo($(this).val())"></td>
							...
							<td style="padding: 0 1px;" id="discprcnt_td" width="3%"><input onkeydown="numcheck(event)" class="form-control-trx" type="text" id="dprcnt" value="0"></td>
					...
					<table id="header_ret_tbl" class="hide">
						<tr align="center" >
							...
							<tr>
								...
								<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="pqty_ret"><input type="hidden" id="punitid_ret" /></td><!-- //Sayantan Mahanty added date-26/02/2020 -->
								<td class="hide"><input class="form-control-trx" type="text" id="stkqty_ret"><input type="hidden" id="stkqtyid_ret" /></td>
		...
		<div class="col-lg-12 col-md-12 col-sm-12" id="footer_detail">
			...
			<table>
				...
				<tr>
					...
					<td style="padding: 2px 5px 0 0"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="cr_note" value="0"></td>
					<td class=""><spring:message code="purinvdet.jsp.spcldisc" text="Spl.Disc%" />:</td>
					<td style="padding: 2px 5px 0 0;"><input class="form-control-trx" type="text" onkeydown="numcheck(event)" id="spldisc" value="0"><input type="hidden" value="0.0" id="spldiscamt"></td>
					...
					<td style="padding: 2px 5px 0 0"><input class="form-control-trx" type="text" onkeydown="numcheck(event)"  id="suppbillamt" value="0.0"></td>
...
<script src="${pageContext.request.contextPath }/assets/js/proc/purchaseinvoice/purchaseinvoice.js"></script>
