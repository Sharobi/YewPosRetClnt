				...
				<input type="hidden" id="isMrpEnableFlag" value="${sessionScope.sesloggedinUser.isMrpEnable}" />
					<table>
						...
						<tr>
							...
							<td width="5%" style="display: none;"><label>Direct <input style="margin-top:5px;" type="checkbox" id="purtype"></label></td>
				...
				<div class="panel-body-trx" id="header_div">
					<table id="header_pur_tbl">
						...
						<tr>
							...
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="pqty" onclick="" onblur="javascript:openSerialModal(Number($(this).val())+Number(Math.floor($('#free').val())))"><input type="hidden" id="punitid" /> <input type="hidden" id="serialnumberreq" value="0" /> <input type="hidden" id="oldpqty" value="0" /></td>
							...
							<td style="padding: 0 1px; width: 8%;" id="exp_td" class="hide"><div class="input-group">
		...
		<div class="col-lg-12 col-md-12 col-sm-12" id="footer_detail">
			...
			<table>
				...
				<tr>
					...
					<td style="padding: 2px 5px 0 0"><input class="form-control-trx" type="text" id="cr_note" value="0"></td>
					<td class=""><spring:message code="purinvdet.jsp.spcldisc" text="Spl.Disc%" />:</td>
					<td style="padding: 2px 5px 0 0;"><input class="form-control-trx" type="text" id="spldisc" value="0"><input type="hidden" value="0.0" id="spldiscamt"></td>
					...
					<td style="padding: 2px 5px 0 0"><input class="form-control-trx" type="text" id="suppbillamt" value="0.0"></td>
			...
			<div class="modal-body">
				...
				<table>
					<tr>
						...
						<td style="padding: 0 1px;"><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="retadjmemoDoc" value="PRM/" size="4" readonly></td>
...
<script src="${pageContext.request.contextPath }/assets/js/proc/purchaseinvoice/purchasebillfromchallan.js"></script>
