		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="panel-trx panel-default">
				<div class="panel-body-trx">
					<form modelAttribute="commonResultSetMapper" action="${pageContext.request.contextPath }/purinv/purchaseinvoiceregistersearch.htm" method="post" id="searchForm">
						<table>
							...
							<tr>
								...
								<td width="45px;" style="padding: 0 1px;"><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="retmemoDoc" value="${purInvDefaultPrefix}/" size="4"></td>
			...
			<table id="purinvtable" class="table table-bordered table-striped table-condensed table-hover">
				<thead>
					<tr>
						...
						<th><spring:message code="purinvdet.jsp.challan" text="Challan No" /></th>
					...
					<c:if test="${!empty purchaseList }">
						<c:forEach items="${purchaseList}" var="purchase">
							<tr id="${purchase.id}">
								...
								<td><c:if test="${purchase.isPosted==1}">
										<button class="btn btn-success btn-xs" onclick="window.location.href='${pageContext.request.contextPath}/purchaseinvoice/loadpurchaseinvoicedet/${purchase.id}.htm'"><spring:message code="cmn.jsp.btn.view" text="View" /></button>
										
									
										<%-- <button class="btn btn-info btn-xs " id="printBySkuBtn" onclick="printPurchaseInvoice(${purchase.id})">
									...
									<c:if test="${purchase.isPosted==0}">
										<c:if test="${menuByUserDTO.isAll==1}">
											...
											<button class="btn btn-info btn-xs" type="button" onclick="window.location.href='${pageContext.request.contextPath}/purchaseinvoice/loadpurchaseinvoicedet/${purchase.id}.htm'">
...
<!-- Confirm Modal end -->
<script src="${pageContext.request.contextPath }/assets/js/proc/purinvreg/purinvoiceregister.js"></script>
