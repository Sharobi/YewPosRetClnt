				...
				<input type="hidden" id="isMrpEnableFlag" value="${sessionScope.sesloggedinUser.isMrpEnable}" />
					<table>
						...
						<tr>
							...
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="billno" value="${purchaseHeader.billNo}" readonly></td>
							...
							<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="distname" value="${purchaseHeader.distName}" readonly><input type="hidden" id="seldistributor" value="${purchaseHeader.distributorId}"></td>
				...
				<div class="panel-body-trx" id="header_div">
					<table id="header_pur_tbl">
						...
						<tr align="center">
							...
							<td colspan="3" class=""><spring:message code="purinvdet.jsp.checkfreeitem" text="Check if free item"/></td>
						</tr>
						<tr>
						...
						<input type="hidden" id="item_taxTypeId" value="0" />
							...
							<td colspan="3" style="padding: 0 1px;text-align: center;" class="">
						...
						<c:if test="${!empty purchaseDetails }">
							<c:forEach items="${purchaseDetails}" var="purchaseDetail" varStatus="purIndex">
								<tr id="tblrow_${purchaseDetail.itemId}_${purchaseDetail.batchNo}" style="cursor: pointer;" onclick="javascript:itemDetailView(${purchaseDetail.itemId},'${purchaseDetail.batchNo}');">
									...
									<td id="tbl_taxTypeId" class="hide">${purchaseDetail.taxTypeId}</td>
									...
									<c:if test="${sessionScope.sesloggedinUser.companyId != 18}">
									<td><button class="btn btn-success btn-xs" id="printBySkuBtn" onclick="javascript:printByBarcode('${purchaseDetail.itemId}','${purchaseDetail.itemName}','${purchaseDetail.sku}',${purchaseDetail.mrp},${purchaseDetail.saleRate},'${purchaseDetail.batchNo}','${purchaseDetail.expiryDateFormat}',${purchaseDetail.packQty+purchaseDetail.freeQty},'${sessionScope.sesloggedinStore.name}','${purchaseDetail.categoryName}','${purchaseDetail.subcategoryName}','${purchaseDetail.colour}','${purchaseDetail.size}','${purchaseDetail.grpName}');">
...
<script src="${pageContext.request.contextPath }/assets/js/proc/purchalan/purchallandet.js"></script>
