...
<div id="printdiv"  style="width:100%;display:flex">
          ...
          <div  style="padding:2px 0px 2px 0px;width:100%;display:flex">
          	 ...
          	 <!--  /*Sayantan Mahanty added date-21/02/2020*/ -->
          	  ...
          	  <div style="width:50%;text-align:center"> 
                    <h3 style="font-size:18px;margine-top:2px;"> <b> PURCHASE ORDER </b> </h3> 
          ...
          <div style="border-top:1px solid black;display:flex;width:100%">
          	  <div style="border-right:1px solid black;padding-bottom:20px;width:50%"> 
                    ...
                    <div style="display:flex;width:100%">
                    	...
                    	<div style="width:50%"> 
                    	     <h4> ${purchaseHeader.distributorName} </h4>
                    	</div>
                    </div>
                    <%-- <div style="display:flex;width:100%">
                    	<div style="width:50%"> 
  ...
  <table style="width:100%;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black">
    ...
    <c:set var="noofline" value="10"></c:set>
						...
						<c:if test="${!empty purchaseDetails }">
							...
							<tr>
						      ...
						      <%-- <td colspan="2"><fmt:formatNumber value="${purchaseDetail.totAmount}" currencySymbol="" type="currency" groupingUsed="false" /></td> --%>
						      <td colspan="2"><fmt:formatNumber value="${purchaseDetail.grossAmount-purchaseDetail.disc}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td><fmt:formatNumber value="${purchaseDetail.disc}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						      <td><fmt:formatNumber value="${purchaseDetail.grossAmount-purchaseDetail.disc}" currencySymbol="" type="currency" groupingUsed="false" /></td>
						    ...
						    <c:set var="totamnt" value="${totamnt+purchaseDetail.grossAmount-purchaseDetail.disc}"></c:set>
						    ...
						    <c:set var="totTexableValue" value="${totTexableValue+purchaseDetail.grossAmount-purchaseDetail.disc}"></c:set>
    ...
    <tr style="border-top:1px solid black">
      ...
      <td><b><fmt:formatNumber value="${purchaseHeader.discAmount}" currencySymbol="" type="currency" groupingUsed="false" /></b></td>
...
$(document).ready(function(){
	...
	window.print();
	//location.href = BASE_URL + '/purorder/'+$("#backUrl").val()+'.htm';
});
