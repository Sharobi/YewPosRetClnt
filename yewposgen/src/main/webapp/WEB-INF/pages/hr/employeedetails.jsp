		...
		<div class="col-lg-12">
			...
			<div class="pull-right">
				<c:if test="${menuByUserDTO.isAll==1}">
					<button class="btn btn-primary" type="button" id="addModal">
			...
			<table id="allemployeestable" class="table table-bordered table-striped table-condensed table-hover display" cellspacing="0" width="100%">
				<thead>
					 <th  class="hide" id="themployeeid">   
