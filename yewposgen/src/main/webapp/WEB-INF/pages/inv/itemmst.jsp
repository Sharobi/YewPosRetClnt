					...
					<!--  this section for add -->
						...
						<c:choose>
							...
							<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
										...
										<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
											...
											<div class="col-sm-8">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
													<input type="text" id="sale_rate" value="0.0" class="form-control-trx" name="saleRate" onkeyup="calculateSaleRate();" placeholder="<spring:message code="itemmstr.jsp.salerate" text="Sale Rate" />">
													</div>
												</div>
 													</c:if>
										...
										<div class="form-group">
											<label class="col-sm-4 col-sm-4 control-label" id="hsn_label"><spring:message code="itemmstr.jsp.hsncode" text="HSN Code" />   <c:if test="${sessionScope.sesloggedinUser.companyId == 18}"><span class="required_star">*</span></c:if></label>
											<div class="col-sm-8">
										...
										<div class="form-group hide">
											<label class="col-sm-4 col-sm-4 control-label" id="hsn_label"><spring:message code="itemmstr.jsp.hsncode" text="HSN Code" /> <span class="required_star">*</span></label>
											<div class="col-sm-8">
											 <input type="text" value="" id="hsnCode" class="form-control-trx" name="hsnCode" placeholder="HSN Code">
											</div>
										</div>
							...
							<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
									...
									<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
										...
										<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
											...
											<div class="col-sm-8">
												<input type="text" id="discount" value="0.0" class="form-control-trx" name="discount" placeholder="Discount%" onkeydown="numcheck(event)">
											</div>
										</div>
											 </c:if>
								...
								<div class="form-group hide">
									...
									<div class="form-group hide">
										...
										<!-- for sale rate   -->
											...
											<label class="col-sm-4 col-sm-4 control-label"><spring:message code="itemmstr.jsp.salerate" text="Sale Rate " /></label>
											<div class="col-sm-8">
												<input type="text" id="sale_rate" value="${itemMaster.saleRate}" class="form-control-trx" name="saleRate" onkeyup="calculateSaleRate();" placeholder="<spring:message code="itemmstr.jsp.salerate" text="Sale Rate" />">
											</div>
										</div>
										 </c:if>
										 <c:if test="${retailTypeControlDTO.controlName=='salerate' && retailTypeControlDTO.isVisible=='0'}">
										...
										<div class="form-group hide">
											...
											<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
											 <c:if test="${retailTypeControlDTO.controlName=='hsncode' && retailTypeControlDTO.isVisible=='1'}">
											<div class="form-group">
											<label class="col-sm-4 col-sm-4 control-label" id="hsn_label">HSN Code <span class="required_star">*</span></label>
											<div class="col-sm-8">
							...
							<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
										...
										<div class="form-group hide">
											...
											<div class="col-sm-8">
												<input type="text" id="maxDiscountLimit" value="${itemMaster.maxDiscountLimit}" class="form-control-trx" name="maxDiscountLimit" placeholder="Max Discount%" onkeydown="numcheck(event)">
											</div>
										</div>
											 </c:if>
										...
										<c:forEach  var="retailTypeControlDTO" items="${retailTypeControlDTOs}">
											...
											<div class="col-sm-8">
												<input type="text" id="discount" value="${itemMaster.discount}" class="form-control-trx" name="discount" placeholder="Discount%" onkeydown="numcheck(event)">
											</div>
										</div>
											 </c:if>
											 <c:if test="${retailTypeControlDTO.controlName=='discperc' && retailTypeControlDTO.isVisible=='0'}">
