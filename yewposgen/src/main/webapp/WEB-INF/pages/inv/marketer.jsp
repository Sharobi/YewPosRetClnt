			...
			<div class="row">
				...
				<div class="panel-body">
					<div class="col-lg-8 col-md-8 col-sm-12">
						<form modelAttribute="marketerMaster" class="form-inline" role="form" action="${pageContext.request.contextPath }/marketer/searchMarketter.htm" method="post">
							<div class="form-group">

								<input type="text" class="form-control" placeholder='<spring:message code="marketer.jsp.name" text="Marketer Name" />' name="name" value="${marketerMaster.name}">
							</div>
							<div class="form-group">
				...
				<!-- Add/Edit Schedule Modal Starts -->
					...
					<div class="modal fade" id="marketAddEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" id="code_label"><spring:message code="marketer.jsp.code" text="Marketer Code" /> <span class="required_star">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" id="name_label"><spring:message code="marketer.jsp.name" text="Marketer Name" /> <span class="required_star">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea  id="addrs" class="form-control" rows="4" placeholder="<spring:message code="marketer.jsp.p_addrs" text="Enter Address" />" ></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="marketer.jsp.phn" text="Contact No." /></label>
							<div class="col-sm-8">
								<input type="text" id="phn" class="form-control"  placeholder="<spring:message code="marketer.jsp.p_phn" text="Enter Contact No." />" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="marketer.jsp.fax" text="FAX" /></label>
							<div class="col-sm-8">
								<input type="text" id="fax" class="form-control" placeholder="<spring:message code="marketer.jsp.p_fax" text="Enter FAX No." />" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="marketer.jsp.email" text="Email" /></label>
							<div class="col-sm-8">
								<input type="text" id="email" class="form-control"  placeholder="<spring:message code="marketer.jsp.p_email" text="Enter Email id" />" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="marketer.jsp.url" text="URL" /></label>
							<div class="col-sm-8">
								<input type="text" id="url" class="form-control" placeholder="<spring:message code="marketer.jsp.p_url" text="Enter URL" />" />
							</div>
						</div>
					</div>
				...
				<thead>
					<tr>
						<th><spring:message code="market.jsp.name" text="Marketter Name" /></th>
						<th><spring:message code="market.jsp.address" text="Address" /></th>
						<th><spring:message code="market.jsp.phone" text="Phone no" /></th>
						<th><spring:message code="cmn.jsp.tblhdr.action" text="Action" /></th>
					</tr>
				</thead>
				
				<tbody>
				<c:if test="${!empty allMarketer}">
					<c:forEach items="${allMarketer}" var="marketermaster">
						<tr>
						<td>${marketermaster.name}</td>
						<td>${marketermaster.address}</td>
						<td>${marketermaster.phone}</td>
						<td>
							<c:if test="${menuByUserDTO.isAll==1}">
								<button class="btn btn-info btn-xs" type="button" onclick="openAddEditModal(${marketermaster.id},&quot;${marketermaster.name}&quot;)">
							...
							<c:if test="${menuByUserDTO.isView==1}">	
								<button class="btn btn-theme04 btn-xs" type="button" onclick="showScheduleDelModal(${marketermaster.id})"><i class="fa fa-trash-o "></i>&nbsp;<spring:message code="cmn.jsp.btn.dlt" text="Delete" /></button>
							</c:if>
						</td>
					</tr>
					</c:forEach>
...
<script src="${pageContext.request.contextPath }/assets/js/inventory/marketer/marketer.js"></script>
<c:if test="${pageContext.response.locale == 'en'}">
	<script src="${pageContext.request.contextPath}/assets/js/inventory/marketer/marketer_en.js"></script>
